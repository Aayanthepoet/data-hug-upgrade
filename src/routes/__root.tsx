...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "PropAI by AI Network Agency. AI-powered owner search, skip tracing, personalized outreach, property redesign, and video marketing — all in one platform." },
